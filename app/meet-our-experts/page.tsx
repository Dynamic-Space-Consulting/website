        ...
        <div className="md:my-12 max-w-6xl mx-auto px-6 md:px-10">
          ...
          >
            ...
            >
              ...
              <p className="font-normal text-base md:text-lg text-[#545556]">
                Aneel specializes in grant writing training, fundraising strategy, and 
                monitoring & evaluation for community development programs across the nonprofit, 
                business, and government sectors in the US, UK, Canada, and Africa. He also has 
                expertise in Technical and Project Management Writing, providing comprehensive 
                support to organizations in their pursuit of funding and impactful projects.
              </p>
            </div>
          </section>
        </div>
