  ...
  return (
    <main>
      ...
      <div className="relative w-full h-64 md:h-96">
        ...
        />
        <h1 className="absolute bottom-4 left-4 text-3xl md:text-5xl text-white font-bold">
          Privacy Policy
        </h1>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-10 space-y-6">
        ...
        <p>Website: <a href="https://www.dynamicspaceconsulting.com" className="text-blue-600 hover:underline">https://www.dynamicspaceconsulting.com</a></p>
        <p>Company: Dynamic Space Consulting (“we,” “our,” “us”)</p>
        ...
        <p>
          ...
          when you visit our website or engage our services. By using our website or services, you agree
        ...
        <p>We do not sell or rent personal data. We may share information only with:</p>
        <ul className="list-disc list-inside space-y-1">
        ...
        <p>We implement appropriate technical and organizational measures to protect your data from unauthorized access, alteration, or disclosure. These include encryption, secure servers, password protection, and limited employee access.</p>

        <h2 className="text-2xl font-semibold mt-6">8. Cookies and Tracking Technologies</h2>
        <p>Our website may use cookies to enhance your browsing experience. Cookies help us understand user behavior and improve our site performance. You can modify your browser settings to disable cookies, but some features of the site may not function properly as a result.</p>
        ...
        <p>Because Dynamic Space Consulting operates globally, your data may be processed or stored outside your country. We ensure that all data transfers comply with applicable data protection laws and that adequate safeguards are in place.</p>

        <h2 className="text-2xl font-semibold mt-6">11. Third-Party Links</h2>
        <p>Our website may include links to third-party websites. We are not responsible for the privacy practices or content of those websites. We encourage you to review their privacy policies before sharing personal information.</p>

        <h2 className="text-2xl font-semibold mt-6">12. Updates to This Policy</h2>
        <p>We may revise this Privacy Policy from time to time. The updated version will be posted on this page with a new “Effective Date.” Please review it periodically to stay informed about how we protect your data.</p>
